...
SELECT	'IMPROVEMENT_PALACE_DUMMY',				'TECH_FUTURE_TECH',		'YIELD_FOOD',		4
WHERE EXISTS (Select * FROM Automates WHERE Type = 'AUTOMATE_MISSIONARY');

INSERT INTO Improvement_TechYieldChanges
		(ImprovementType,						TechType,				YieldType,			Yield)
SELECT	'IMPROVEMENT_IRONWORKS_DUMMY',			'TECH_FUTURE_TECH',		'YIELD_PRODUCTION',	4
WHERE EXISTS (Select * FROM Automates WHERE Type = 'AUTOMATE_MISSIONARY');
			
INSERT INTO Improvement_TechYieldChanges
		(ImprovementType,						TechType,				YieldType,			Yield)
SELECT	'IMPROVEMENT_NATIONAL_TREASURY_DUMMY',	'TECH_FUTURE_TECH',		'YIELD_GOLD',		4
WHERE EXISTS (Select * FROM Automates WHERE Type = 'AUTOMATE_MISSIONARY');

INSERT INTO Improvement_TechYieldChanges
		(ImprovementType,						TechType,				YieldType,			Yield)
SELECT	'IMPROVEMENT_GRAND_TEMPLE_DUMMY',		'TECH_FUTURE_TECH',		'YIELD_FAITH',		4
WHERE EXISTS (Select * FROM Automates WHERE Type = 'AUTOMATE_MISSIONARY');

INSERT INTO Improvement_TechYieldChanges
		(ImprovementType,						TechType,				YieldType,			Yield)
SELECT	'IMPROVEMENT_HERMITAGE_DUMMY',			'TECH_FUTURE_TECH',		'YIELD_CULTURE',	4
WHERE EXISTS (Select * FROM Automates WHERE Type = 'AUTOMATE_MISSIONARY');

INSERT INTO Improvement_TechYieldChanges
		(ImprovementType,						TechType,				YieldType,			Yield)
SELECT	'IMPROVEMENT_NATIONAL_COLLEGE_DUMMY',	'TECH_FUTURE_TECH',		'YIELD_SCIENCE',	4
WHERE EXISTS (Select * FROM Automates WHERE Type = 'AUTOMATE_MISSIONARY');
